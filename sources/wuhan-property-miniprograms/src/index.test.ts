...
describe("Wuhan property mini-program observations", () => {
  it("normalizes a claimed observation and preserves its share reference", async () => {
    ...
    expect(result.data).toEqual(expect.objectContaining({ evidenceStatus: "claimed", candidateId: "candidate-1", areaSqm: 92, purchasePrice: { minimumCny: 1500000, maximumCny: 1500000 } }));
